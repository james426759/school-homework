...
<html lang="en">
  ...
  <body class="bg" ">
      ...
      $db = new PDO($dsn, $user, $pass, array(PDO::ATTR_PERSISTENT => true));
        ...
        $sql = "SELECT * FROM search WHERE id= '".$_GET['id']."' ";
    ...
    if($row['video'] != null){
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 "> 
            <div class="thumbnail">
                <h2 align="center">'.$row['article'].'</h2>
                <img alt="" src="'.$row['photo'].'" />
                <br>
                <p align="left"><font size="4">'.$row['content'].'</p>
                <div class=video-container>
                  <iframe src="'.$row['video'].'" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
                </div>
            </div>
          </div>
        </div>
